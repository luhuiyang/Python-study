...
def center_rect(x, y, w, h, color):
    conor_x = x - w / 2
    conor_y = y + h / 2
    rect(conor_x, conor_y, w, h, color)

# center_rect(0, 0, 200, 300, '#00ff00')
# 3
# 实现一个圆形函数
# x y 是圆心坐标
# r 是半径
...
def japan():
    x, y, w, h = 0, 0, 300, 200
    center_rect(x, y, w, h, '#000000')
    circle(x, y, 50, '#ff0000')
...
# def germany()
def germany():
    x, y, w, height = 0, 0, 300, 200
    h = height / 3
    y1 = y
    y2 = y - h
    y3 = y - h - h
    rect(x, y1, w, h, '#000000')
    rect(x, y2, w, h, '#ff0000')
    rect(x, y3, w, h, '#ffff00')
...
def gambia():
    ...
    y2 = y - h
    y3 = y - h - h
    rect(x, y1, w, h, '#ff0000')
    rect(x, y2, w, h, '#ffffff')
    rect(x, y3, w, h, '#00ff00')
    center_rect(x + w / 2, y - height / 2, w, height / 8, '#0000ff')
...
def switzerland():
    ...
    log('switzer land', cross_w, cross_h)
